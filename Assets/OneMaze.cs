...
public class OneMaze : Agent
{
    ...
    public Transform overallMaze;
    public Transform overallPeople;
    ...
    public override void AgentReset()
    {
        ...
        //pos.y = 0.5f;
        gameObject.transform.localPosition = new Vector3(-9.5f, 0f, -9.5f);
    ...
    public void OnCollisionEnter(Collision collisionInfo)
    {
        ...
        {
            agentSearchArea = collisionInfo.collider.gameObject.GetComponent<OneMaze>().searchArea;
            ...
            agentPeopleArea = collisionInfo.collider.gameObject.GetComponent<OneMaze>().peopleArea;
    ...
    {
        if(collisionInfo.tag == "NotFound")
        {
            //print("trigger");
            if(searchArea[collisionInfo.transform.parent.GetSiblingIndex()] == 0f)
            {
                FoundSquare(collisionInfo.transform.parent.GetSiblingIndex());
            }
        }
    }
    */
    ...
    public virtual void Finished()
    {
        ...
        Component[] CoopScript = parent.GetComponentsInChildren<OneMaze>();
        foreach(OneMaze script in CoopScript)
        {
